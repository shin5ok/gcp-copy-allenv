...
- CAI 検出リソース: **69** 件 / TF 出力リソース: **3** 件 / 一致: **0** 件 / 欠落候補: **69** 件
...
- full name: `//compute.googleapis.com/projects/<SRC_HOST_PROJECT_ID>/regions/asia-northeast1/addresses/svc2-ip1`
...
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe svc2-ip1 --region=asia-northeast1 --project=<SRC_HOST_PROJECT_ID>
  gcloud compute addresses create svc2-ip1 --project=<DST_HOST_PROJECT_ID> --region=asia-northeast1
  ```

#### `svc1-fix1` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_HOST_PROJECT_ID>/regions/asia-northeast1/addresses/svc1-fix1`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe svc1-fix1 --region=asia-northeast1 --project=<SRC_HOST_PROJECT_ID>
  gcloud compute addresses create svc1-fix1 --project=<DST_HOST_PROJECT_ID> --region=asia-northeast1
  ```

#### `fix-tokyo2-1` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_HOST_PROJECT_ID>/regions/asia-northeast1/addresses/fix-tokyo2-1`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe fix-tokyo2-1 --region=asia-northeast1 --project=<SRC_HOST_PROJECT_ID>
  gcloud compute addresses create fix-tokyo2-1 --project=<DST_HOST_PROJECT_ID> --region=asia-northeast1
  ```

#### `fix-tokyo1` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_HOST_PROJECT_ID>/regions/asia-northeast1/addresses/fix-tokyo1`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe fix-tokyo1 --region=asia-northeast1 --project=<SRC_HOST_PROJECT_ID>
  gcloud compute addresses create fix-tokyo1 --project=<DST_HOST_PROJECT_ID> --region=asia-northeast1
  ```

#### `nat-auto-ip-10281266-0-1781794550182258` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_HOST_PROJECT_ID>/regions/asia-northeast1/addresses/nat-auto-ip-10281266-0-1781794550182258`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe nat-auto-ip-10281266-0-1781794550182258 --region=asia-northeast1 --project=<SRC_HOST_PROJECT_ID>
  gcloud compute addresses create nat-auto-ip-10281266-0-1781794550182258 --project=<DST_HOST_PROJECT_ID> --region=asia-northeast1
  ```
...
#### `5dc05561735f5535ae6df2f045909849c72b7837` (location=`global`)

- full name: `//iam.googleapis.com/projects/<SRC_HOST_PROJECT_ID>/serviceAccounts/115136696460297707264/keys/5dc05561735f5535ae6df2f045909849c72b7837`
- 担当ステップ: `意図的対象外 (None)`
- 期待 TF 型: `なし`
- 判定理由: 意図的に対象外（マップで None 指定）
- 推奨コマンド:
  ```bash
  gcloud asset describe '//iam.googleapis.com/projects/<SRC_HOST_PROJECT_ID>/serviceAccounts/115136696460297707264/keys/5dc05561735f5535ae6df2f045909849c72b7837' --project=<SRC_HOST_PROJECT_ID>
  # iam.googleapis.com/ServiceAccountKey は自動補完対象外。手動でドキュメント参照のうえ dst で再作成してください。
  ```

#### `51611a24641c065b352bf270ed4fee2a55df9808` (location=`global`)

- full name: `//iam.googleapis.com/projects/<SRC_HOST_PROJECT_ID>/serviceAccounts/105601367421165273808/keys/51611a24641c065b352bf270ed4fee2a55df9808`
- 担当ステップ: `意図的対象外 (None)`
- 期待 TF 型: `なし`
- 判定理由: 意図的に対象外（マップで None 指定）
- 推奨コマンド:
  ```bash
  gcloud asset describe '//iam.googleapis.com/projects/<SRC_HOST_PROJECT_ID>/serviceAccounts/105601367421165273808/keys/51611a24641c065b352bf270ed4fee2a55df9808' --project=<SRC_HOST_PROJECT_ID>
  # iam.googleapis.com/ServiceAccountKey は自動補完対象外。手動でドキュメント参照のうえ dst で再作成してください。
  ```
...
- CAI 検出リソース: **118** 件 / TF 出力リソース: **3** 件 / 一致: **1** 件 / 欠落候補: **117** 件
...
- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/regions/asia-northeast1/addresses/org-svc1-deb-e2-mic-101-ip`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe org-svc1-deb-e2-mic-101-ip --region=asia-northeast1 --project=<SRC_SERVICE_PROJECT_ID_1>
  gcloud compute addresses create org-svc1-deb-e2-mic-101-ip --project=<DST_SERVICE_PROJECT_ID_1> --region=asia-northeast1
  ```

#### `sharedvpcip` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/regions/asia-northeast1/addresses/sharedvpcip`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe sharedvpcip --region=asia-northeast1 --project=<SRC_SERVICE_PROJECT_ID_1>
  gcloud compute addresses create sharedvpcip --project=<DST_SERVICE_PROJECT_ID_1> --region=asia-northeast1
  ```
...
- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/zones/asia-northeast1-a/disks/org-svc1-deb-e2-mic-101`
- 担当ステップ: `gce_restore`
...
- 推奨コマンド:
  ```bash
  gcloud compute disks describe org-svc1-deb-e2-mic-101 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_1>
  gcloud compute disks create org-svc1-deb-e2-mic-101 --project=<DST_SERVICE_PROJECT_ID_1> --zone=asia-northeast1-a --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore)
  ```

#### `fix-ip-vm` (location=`asia-northeast1-b`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/zones/asia-northeast1-b/disks/fix-ip-vm`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_disk/google_compute_region_disk`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_disk/google_compute_region_disk)
- 推奨コマンド:
  ```bash
  gcloud compute disks describe fix-ip-vm --zone=asia-northeast1-b --project=<SRC_SERVICE_PROJECT_ID_1>
  gcloud compute disks create fix-ip-vm --project=<DST_SERVICE_PROJECT_ID_1> --zone=asia-northeast1-b --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore)
  ```
...
- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/zones/asia-northeast1-a/instances/org-svc1-deb-e2-mic-101`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_instance`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_instance)
- 推奨コマンド:
  ```bash
  gcloud compute instances describe org-svc1-deb-e2-mic-101 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_1>
  gcloud compute instances create org-svc1-deb-e2-mic-101 --project=<DST_SERVICE_PROJECT_ID_1> --zone=asia-northeast1-a --machine-type=<MACHINE_TYPE> --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore) が担当
  ```

#### `fix-ip-vm` (location=`asia-northeast1-b`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/zones/asia-northeast1-b/instances/fix-ip-vm`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_instance`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_instance)
- 推奨コマンド:
  ```bash
  gcloud compute instances describe fix-ip-vm --zone=asia-northeast1-b --project=<SRC_SERVICE_PROJECT_ID_1>
  gcloud compute instances create fix-ip-vm --project=<DST_SERVICE_PROJECT_ID_1> --zone=asia-northeast1-b --machine-type=<MACHINE_TYPE> --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore) が担当
  ```
...
### `compute.googleapis.com/Snapshot` （40 件）

#### `fix-ip-vm-asia-northeast1-b-20260622184701-34bhhx2g` (location=`asia`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/fix-ip-vm-asia-northeast1-b-20260622184701-34bhhx2g`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe fix-ip-vm-asia-northeast1-b-20260622184701-34bhhx2g --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `windows-asia-northeast1-c-20260622184701-hoj238od` (location=`asia`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/windows-asia-northeast1-c-20260622184701-hoj238od`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe windows-asia-northeast1-c-20260622184701-hoj238od --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `windows-asia-northeast1-c-20260621184701-yq0mmmti` (location=`asia`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/windows-asia-northeast1-c-20260621184701-yq0mmmti`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe windows-asia-northeast1-c-20260621184701-yq0mmmti --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `fix-ip-vm-asia-northeast1-b-20260621184701-azfr72d0` (location=`asia`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/fix-ip-vm-asia-northeast1-b-20260621184701-azfr72d0`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe fix-ip-vm-asia-northeast1-b-20260621184701-azfr72d0 --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `windows-asia-northeast1-c-20260620184702-58ngctx7` (location=`asia`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/windows-asia-northeast1-c-20260620184702-58ngctx7`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe windows-asia-northeast1-c-20260620184702-58ngctx7 --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `fix-ip-vm-asia-northeast1-b-20260620184702-ehb0ztw8` (location=`asia`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/fix-ip-vm-asia-northeast1-b-20260620184702-ehb0ztw8`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe fix-ip-vm-asia-northeast1-b-20260620184702-ehb0ztw8 --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `windows-asia-northeast1-c-20260619184701-kbgeu025` (location=`asia`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/windows-asia-northeast1-c-20260619184701-kbgeu025`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe windows-asia-northeast1-c-20260619184701-kbgeu025 --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `fix-ip-vm-asia-northeast1-b-20260619184701-4sxc06lf` (location=`asia`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/fix-ip-vm-asia-northeast1-b-20260619184701-4sxc06lf`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe fix-ip-vm-asia-northeast1-b-20260619184701-4sxc06lf --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `org-svc1-deb-e2-mic-101-init-snap` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/org-svc1-deb-e2-mic-101-init-snap`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe org-svc1-deb-e2-mic-101-init-snap --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `windows-asia-northeast1-c-20260618184701-7zerv6lq` (location=`asia`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/windows-asia-northeast1-c-20260618184701-7zerv6lq`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe windows-asia-northeast1-c-20260618184701-7zerv6lq --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `fix-ip-vm-asia-northeast1-b-20260618184701-fppz5xml` (location=`asia`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/fix-ip-vm-asia-northeast1-b-20260618184701-fppz5xml`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe fix-ip-vm-asia-northeast1-b-20260618184701-fppz5xml --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `backup-for-fix-ip-vm` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/global/snapshots/backup-for-fix-ip-vm`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe backup-for-fix-ip-vm --project=<SRC_SERVICE_PROJECT_ID_1>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```
...
#### `75df707f9075b778a43ba0134bc595d67ef2fd98` (location=`global`)

- full name: `//iam.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/serviceAccounts/117381527922619443535/keys/75df707f9075b778a43ba0134bc595d67ef2fd98`
- 担当ステップ: `意図的対象外 (None)`
- 期待 TF 型: `なし`
- 判定理由: 意図的に対象外（マップで None 指定）
- 推奨コマンド:
  ```bash
  gcloud asset describe '//iam.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/serviceAccounts/117381527922619443535/keys/75df707f9075b778a43ba0134bc595d67ef2fd98' --project=<SRC_SERVICE_PROJECT_ID_1>
  # iam.googleapis.com/ServiceAccountKey は自動補完対象外。手動でドキュメント参照のうえ dst で再作成してください。
  ```

#### `102e4359fb171600e8011fcb1f7051d3907f0740` (location=`global`)

- full name: `//iam.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/serviceAccounts/102818933073389942664/keys/102e4359fb171600e8011fcb1f7051d3907f0740`
- 担当ステップ: `意図的対象外 (None)`
- 期待 TF 型: `なし`
- 判定理由: 意図的に対象外（マップで None 指定）
- 推奨コマンド:
  ```bash
  gcloud asset describe '//iam.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_1>/serviceAccounts/102818933073389942664/keys/102e4359fb171600e8011fcb1f7051d3907f0740' --project=<SRC_SERVICE_PROJECT_ID_1>
  # iam.googleapis.com/ServiceAccountKey は自動補完対象外。手動でドキュメント参照のうえ dst で再作成してください。
  ```
...
- CAI 検出リソース: **190** 件 / TF 出力リソース: **3** 件 / 一致: **0** 件 / 欠落候補: **190** 件
...
- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/regions/asia-northeast1/addresses/org-svc3-ub-e2-med-303-ip`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe org-svc3-ub-e2-med-303-ip --region=asia-northeast1 --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute addresses create org-svc3-ub-e2-med-303-ip --project=<DST_SERVICE_PROJECT_ID_3> --region=asia-northeast1
  ```

#### `org-svc3-ub-e2-med-302-ip` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/regions/asia-northeast1/addresses/org-svc3-ub-e2-med-302-ip`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe org-svc3-ub-e2-med-302-ip --region=asia-northeast1 --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute addresses create org-svc3-ub-e2-med-302-ip --project=<DST_SERVICE_PROJECT_ID_3> --region=asia-northeast1
  ```

#### `org-svc3-ub-e2-mic-301-ip` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/regions/asia-northeast1/addresses/org-svc3-ub-e2-mic-301-ip`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe org-svc3-ub-e2-mic-301-ip --region=asia-northeast1 --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute addresses create org-svc3-ub-e2-mic-301-ip --project=<DST_SERVICE_PROJECT_ID_3> --region=asia-northeast1
  ```

#### `org-svc3-ub-e2-mic-302-ip` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/regions/asia-northeast1/addresses/org-svc3-ub-e2-mic-302-ip`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe org-svc3-ub-e2-mic-302-ip --region=asia-northeast1 --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute addresses create org-svc3-ub-e2-mic-302-ip --project=<DST_SERVICE_PROJECT_ID_3> --region=asia-northeast1
  ```

#### `org-svc3-ub-e2-med-301-ip` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/regions/asia-northeast1/addresses/org-svc3-ub-e2-med-301-ip`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe org-svc3-ub-e2-med-301-ip --region=asia-northeast1 --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute addresses create org-svc3-ub-e2-med-301-ip --project=<DST_SERVICE_PROJECT_ID_3> --region=asia-northeast1
  ```

#### `org-svc3-ub-c2-std4-301-ip` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/regions/asia-northeast1/addresses/org-svc3-ub-c2-std4-301-ip`
- 担当ステップ: `terraform_apply`
- 期待 TF 型: `google_compute_address/google_compute_global_address`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_address/google_compute_global_address)
- 推奨コマンド:
  ```bash
  gcloud compute addresses describe org-svc3-ub-c2-std4-301-ip --region=asia-northeast1 --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute addresses create org-svc3-ub-c2-std4-301-ip --project=<DST_SERVICE_PROJECT_ID_3> --region=asia-northeast1
  ```
...
- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/disks/org-svc3-ub-e2-med-302`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_disk/google_compute_region_disk`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_disk/google_compute_region_disk)
- 推奨コマンド:
  ```bash
  gcloud compute disks describe org-svc3-ub-e2-med-302 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute disks create org-svc3-ub-e2-med-302 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore)
  ```

#### `org-svc3-ub-e2-med-303` (location=`asia-northeast1-a`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/disks/org-svc3-ub-e2-med-303`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_disk/google_compute_region_disk`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_disk/google_compute_region_disk)
- 推奨コマンド:
  ```bash
  gcloud compute disks describe org-svc3-ub-e2-med-303 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute disks create org-svc3-ub-e2-med-303 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore)
  ```

#### `org-svc3-ub-e2-mic-302` (location=`asia-northeast1-a`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/disks/org-svc3-ub-e2-mic-302`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_disk/google_compute_region_disk`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_disk/google_compute_region_disk)
- 推奨コマンド:
  ```bash
  gcloud compute disks describe org-svc3-ub-e2-mic-302 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute disks create org-svc3-ub-e2-mic-302 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore)
  ```

#### `org-svc3-ub-e2-mic-301` (location=`asia-northeast1-a`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/disks/org-svc3-ub-e2-mic-301`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_disk/google_compute_region_disk`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_disk/google_compute_region_disk)
- 推奨コマンド:
  ```bash
  gcloud compute disks describe org-svc3-ub-e2-mic-301 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute disks create org-svc3-ub-e2-mic-301 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore)
  ```

#### `org-svc3-ub-e2-med-301` (location=`asia-northeast1-a`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/disks/org-svc3-ub-e2-med-301`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_disk/google_compute_region_disk`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_disk/google_compute_region_disk)
- 推奨コマンド:
  ```bash
  gcloud compute disks describe org-svc3-ub-e2-med-301 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute disks create org-svc3-ub-e2-med-301 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore)
  ```

#### `org-svc3-ub-c2-std4-301` (location=`asia-northeast1-a`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/disks/org-svc3-ub-c2-std4-301`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_disk/google_compute_region_disk`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_disk/google_compute_region_disk)
- 推奨コマンド:
  ```bash
  gcloud compute disks describe org-svc3-ub-c2-std4-301 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute disks create org-svc3-ub-c2-std4-301 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore)
  ```
...
- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/instances/org-svc3-ub-e2-med-302`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_instance`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_instance)
- 推奨コマンド:
  ```bash
  gcloud compute instances describe org-svc3-ub-e2-med-302 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute instances create org-svc3-ub-e2-med-302 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --machine-type=<MACHINE_TYPE> --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore) が担当
  ```

#### `org-svc3-ub-e2-med-303` (location=`asia-northeast1-a`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/instances/org-svc3-ub-e2-med-303`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_instance`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_instance)
- 推奨コマンド:
  ```bash
  gcloud compute instances describe org-svc3-ub-e2-med-303 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute instances create org-svc3-ub-e2-med-303 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --machine-type=<MACHINE_TYPE> --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore) が担当
  ```

#### `org-svc3-ub-e2-mic-301` (location=`asia-northeast1-a`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/instances/org-svc3-ub-e2-mic-301`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_instance`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_instance)
- 推奨コマンド:
  ```bash
  gcloud compute instances describe org-svc3-ub-e2-mic-301 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute instances create org-svc3-ub-e2-mic-301 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --machine-type=<MACHINE_TYPE> --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore) が担当
  ```

#### `org-svc3-ub-e2-mic-302` (location=`asia-northeast1-a`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/instances/org-svc3-ub-e2-mic-302`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_instance`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_instance)
- 推奨コマンド:
  ```bash
  gcloud compute instances describe org-svc3-ub-e2-mic-302 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute instances create org-svc3-ub-e2-mic-302 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --machine-type=<MACHINE_TYPE> --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore) が担当
  ```

#### `org-svc3-ub-e2-med-301` (location=`asia-northeast1-a`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/instances/org-svc3-ub-e2-med-301`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_instance`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_instance)
- 推奨コマンド:
  ```bash
  gcloud compute instances describe org-svc3-ub-e2-med-301 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute instances create org-svc3-ub-e2-med-301 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --machine-type=<MACHINE_TYPE> --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore) が担当
  ```

#### `org-svc3-ub-c2-std4-301` (location=`asia-northeast1-a`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/zones/asia-northeast1-a/instances/org-svc3-ub-c2-std4-301`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_instance`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_instance)
- 推奨コマンド:
  ```bash
  gcloud compute instances describe org-svc3-ub-c2-std4-301 --zone=asia-northeast1-a --project=<SRC_SERVICE_PROJECT_ID_3>
  gcloud compute instances create org-svc3-ub-c2-std4-301 --project=<DST_SERVICE_PROJECT_ID_3> --zone=asia-northeast1-a --machine-type=<MACHINE_TYPE> --source-snapshot=<SNAPSHOT>  # 通常は Step 5 (gce_restore) が担当
  ```
...
- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/global/snapshots/org-svc3-ub-e2-med-302-init-snap`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe org-svc3-ub-e2-med-302-init-snap --project=<SRC_SERVICE_PROJECT_ID_3>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `org-svc3-ub-e2-med-301-init-snap` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/global/snapshots/org-svc3-ub-e2-med-301-init-snap`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe org-svc3-ub-e2-med-301-init-snap --project=<SRC_SERVICE_PROJECT_ID_3>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `org-svc3-ub-e2-med-303-init-snap` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/global/snapshots/org-svc3-ub-e2-med-303-init-snap`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe org-svc3-ub-e2-med-303-init-snap --project=<SRC_SERVICE_PROJECT_ID_3>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `org-svc3-ub-c2-std4-301-init-snap` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/global/snapshots/org-svc3-ub-c2-std4-301-init-snap`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe org-svc3-ub-c2-std4-301-init-snap --project=<SRC_SERVICE_PROJECT_ID_3>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `org-svc3-ub-e2-mic-302-init-snap` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/global/snapshots/org-svc3-ub-e2-mic-302-init-snap`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe org-svc3-ub-e2-mic-302-init-snap --project=<SRC_SERVICE_PROJECT_ID_3>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```

#### `org-svc3-ub-e2-mic-301-init-snap` (location=`asia-northeast1`)

- full name: `//compute.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/global/snapshots/org-svc3-ub-e2-mic-301-init-snap`
- 担当ステップ: `gce_restore`
- 期待 TF 型: `google_compute_snapshot`
- 判定理由: bulk-export が出力しなかった (期待 TF 型: google_compute_snapshot)
- 推奨コマンド:
  ```bash
  gcloud compute snapshots describe org-svc3-ub-e2-mic-301-init-snap --project=<SRC_SERVICE_PROJECT_ID_3>
  # snapshot は src 側からの参照で復元する設計のため dst 作成は不要 (Step 5 gce_restore が source-snapshot として直接使用)
  ```
...
### `iam.googleapis.com/ServiceAccountKey` （3 件）

#### `5b45c8774bc7b33765a50458285e9359908618d3` (location=`global`)

- full name: `//iam.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/serviceAccounts/100682100138600860386/keys/5b45c8774bc7b33765a50458285e9359908618d3`
- 担当ステップ: `意図的対象外 (None)`
- 期待 TF 型: `なし`
- 判定理由: 意図的に対象外（マップで None 指定）
- 推奨コマンド:
  ```bash
  gcloud asset describe '//iam.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/serviceAccounts/100682100138600860386/keys/5b45c8774bc7b33765a50458285e9359908618d3' --project=<SRC_SERVICE_PROJECT_ID_3>
  # iam.googleapis.com/ServiceAccountKey は自動補完対象外。手動でドキュメント参照のうえ dst で再作成してください。
  ```

#### `10c2bde58c9e8edbad19c5ece9637cd16a37a160` (location=`global`)

- full name: `//iam.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/serviceAccounts/104507197771240164503/keys/10c2bde58c9e8edbad19c5ece9637cd16a37a160`
- 担当ステップ: `意図的対象外 (None)`
- 期待 TF 型: `なし`
- 判定理由: 意図的に対象外（マップで None 指定）
- 推奨コマンド:
  ```bash
  gcloud asset describe '//iam.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/serviceAccounts/104507197771240164503/keys/10c2bde58c9e8edbad19c5ece9637cd16a37a160' --project=<SRC_SERVICE_PROJECT_ID_3>
  # iam.googleapis.com/ServiceAccountKey は自動補完対象外。手動でドキュメント参照のうえ dst で再作成してください。
  ```

#### `f101ea81ac2265423524e55d73e6275cf5e524c2` (location=`global`)

- full name: `//iam.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/serviceAccounts/111275084942843190583/keys/f101ea81ac2265423524e55d73e6275cf5e524c2`
- 担当ステップ: `意図的対象外 (None)`
- 期待 TF 型: `なし`
- 判定理由: 意図的に対象外（マップで None 指定）
- 推奨コマンド:
  ```bash
  gcloud asset describe '//iam.googleapis.com/projects/<SRC_SERVICE_PROJECT_ID_3>/serviceAccounts/111275084942843190583/keys/f101ea81ac2265423524e55d73e6275cf5e524c2' --project=<SRC_SERVICE_PROJECT_ID_3>
  # iam.googleapis.com/ServiceAccountKey は自動補完対象外。手動でドキュメント参照のうえ dst で再作成してください。
  ```
