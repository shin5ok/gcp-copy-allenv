...
| **Service Project 1** | `<SRC_SERVICE_PROJECT_ID_1>` | リソース配置先 |
| **Service Project 2** | `<SRC_SERVICE_PROJECT_ID_3>` | リソース配置先 |
...
| :--- | :--- | :--- | :--- |
| `subnet-svc1` | `10.100.1.0/24` | `<SRC_SERVICE_PROJECT_ID_1>` | 自動スキャンによる検出 |
| `subnet-svc3` | `10.100.3.0/24` | `<SRC_SERVICE_PROJECT_ID_3>` | 自動スキャンによる検出 |
| `tokyo` | `10.0.0.0/16` | `<SRC_HOST_PROJECT_ID>` | 自動スキャンによる検出 |
| `tokyo-2` | `10.1.0.0/16` | `<SRC_HOST_PROJECT_ID>` | 自動スキャンによる検出 |
...
### 3.2. Service Project 2 (`<SRC_SERVICE_PROJECT_ID_3>`)
